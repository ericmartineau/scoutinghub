...
import scoutinghub.geo.YahooPlaceFinderGeoEncodingService
...
class LeaderService {
    ...
    YahooPlaceFinderGeoEncodingService yahooPlaceFinderGeoEncodingService
    ...
    def getGeoCodeForLeader(Leader leader) {
        ...
        return yahooPlaceFinderGeoEncodingService.getCoordinatesForAddress(address)
    }
