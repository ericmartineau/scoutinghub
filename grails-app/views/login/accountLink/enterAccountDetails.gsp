<head>
    ...
    <title><g:message code="flow.enterAccountDetails.title"/></title>
</head>
...
<div class='body'>
    ...
    <g:header><g:message code="flow.enterAccountDetails.title"/></g:header>


    <div id="createAccount">
        <g:form action="accountLink">
            <div class="explain"><g:message code="flow.enterAccountDetails.message"/></div>
            <table width="100%" id='createAccount'>
                <tr>
                    ...
                    <td width="50%" valign="center" align="center">
                        ...
                        <div class="fldContainer">
                            <g:submitButton class="ui-button" name="verifyByEmail" value="${message(code: 'flow.verifyUserPass.verifyEmailButton')}" />
                        </div>
