...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="certification.description.label"
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="certification.trainingUrl.label" default="Training URL"/></td>

                <td valign="top" class="value">${fieldValue(bean: certificationInstance, field: "trainingUrl")}</td>

            </tr>

            <tr class="prop">
                <td valign="top" class="name"><g:message code="certification.durationInDays.label"
                                                         default="Duration In Days"/></td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="certification.tourPermitRequired.label"
                                                         default="Tour Permit Required"/></td>

                <td valign="top" class="value"><g:formatBoolean
                        boolean="${certificationInstance?.tourPermitRequired}"/></td>

            </tr>

            <tr class="prop">
                <td valign="top" class="name"><g:message code="certification.createDate.label"
                                                         default="Create Date"/></td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="certification.updateDate.label"
                                                         default="Update Date"/></td>
                ...
                <td valign="top" style="text-align: left;" class="value">
                    <ul>
                        <g:each in="${certificationInstance.leaderCertifications}" var="l">
                            <li><g:link controller="leaderCertification" action="show"
