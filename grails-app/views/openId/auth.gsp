...
<s:content class="twoContent">
    <s:row class="foo">
        <form action='${daoPostUrl}' method='POST' id='loginForm' class='cssform' autocomplete='off'>
            <s:section span="6" header="small" code="login.enteruandp" center="true">
        ...
        <s:section span="6" noRow="true" header="small" code="login.firstTimeHere" class="center">
        ...
        <s:section span="6" noRow="true" header="small" code="login.firstTimeHere" class="center form-inline">
