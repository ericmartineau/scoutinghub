...
<head>
    ...
    <title><g:message code="unitAdmin.importStatus.title"/></title>
    <script type="text/javascript">
        jQuery(document).ready(refreshStatus);

        function refreshStatus() {
            jQuery.getJSON("/scoutinghub/unitAdmin/importStatusPoll", "", function(json) {
        ...
        function showErrors(sheetIndex) {
            ...
            jQuery("<div id='errDialog'></div>").load("/scoutinghub/unitAdmin/getImportErrors", {sheetIndex:sheetIndex}, function() {
                    ...
                    <tr>
                        <td align="left">
                            <g:if test="${!session?.importJob?.alive}">
                                <g:msgbox type="info">
                                    <div class="msg1"><g:message code="unitAdmin.importStatus.importComplete"/></div>
                                </g:msgbox>
                            </g:if>
                            ...
                            <h2><g:message code="unitAdmin.importStatus.header"/></h2>
