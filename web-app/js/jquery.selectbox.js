/*
	...
	Known Issues:
		...
		- Width should be set as an inline style or using the 'width' property in your CSS; min-width
		  and max-width are not currently supported.
			...
			var init = function(select, data) {
				...
				if( inline ) {
					...
					if( !select[0].style.height ) {
						var optionHeight = parseInt(control.find('.selectBox-options A:first').height());
